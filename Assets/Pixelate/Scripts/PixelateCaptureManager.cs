...
namespace Pixelate
{
    ...
    public class PixelateCaptureManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private Texture2D _previewImage = null;
        ...
        public IEnumerator PreviewAnimation()
        {
            ...
            if (_pixelated)
                diffuseMap.filterMode = FilterMode.Point;
            else
                diffuseMap.filterMode = FilterMode.Bilinear;

            _previewImage = diffuseMap;
        ...
        public IEnumerator CaptureFrame(Action<Texture2D, Texture2D, bool, bool, bool, Vector2, Vector2, AnimationClip> onComplete)
        {
            ...
            try
            {
                ...
                onComplete.Invoke(diffuseMap, normalMap, _createNormalMap, _useAnimation, _pixelated, _cellSize, new Vector2(0.5f, 0.5f), null);
            }
            finally
            {
                QualitySettings.renderPipeline = defaultQualityPipeline;
